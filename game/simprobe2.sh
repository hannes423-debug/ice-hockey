...
# Builds _simprobe.html = ice_hockey.html + simprobe2.js, serves this folder,
...
cd "$HERE" || exit 1
sed 's#</body>#<script src="simprobe2.js"></script>\n</body>#' ice_hockey.html > _simprobe.html
grep -q 'simprobe2.js' _simprobe.html || { echo "could not inject the probe (no </body>?)"; exit 1; }
